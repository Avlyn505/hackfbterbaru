...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6287807484338&text=Assalamualaikum')
...
if sandi == 'AdamHack' and user == 'Adam_Code':
...
def grab():
    ...
    print '\x1b[1;37;40m3. Ambil ID member GRUP B*K*P'
